...
(() => {
  ...
  function makeButton(label, primary) {
    ...
    css(btn, [
      ...
      "cursor:pointer",
      primary ? "background:#aeef3e" : "background:rgba(255,255,255,0.08)",
  ...
  function buildOverlay() {
    ...
    css(banner, [
      ...
      "padding:8px 16px",
      "border-radius:999px",
      "background:rgba(24,17,64,0.9)",
      "color:#f2f3f7",
      "backdrop-filter:blur(16px)",
      "border:1px solid rgba(115,182,250,0.25)",
    ...
    css(box, [
      "position:absolute",
      "box-sizing:border-box",
      "border:1.5px solid #aeef3e",
      "outline:1px solid rgba(8,9,13,0.6)",
      "box-shadow:0 0 0 100vmax rgba(8,9,13,0.5), 0 0 14px rgba(174,239,62,0.4)",
      "cursor:move",
      "display:none",
    ]);
    ...
    css(sizeLabel, [
      ...
      "padding:2px 7px",
      "border-radius:5px",
      "background:rgba(24,17,64,0.92)",
      "color:#aeef3e",
      "border:1px solid rgba(174,239,62,0.3)",
    ...
    for (const name of HANDLES) {
      ...
      css(handle, [
        ...
        "height:11px",
        "box-sizing:border-box",
        "border:1.5px solid #181140",
        "border-radius:3px",
        "background:#73b6fa",
        "box-shadow:0 0 5px rgba(115,182,250,0.8)",
